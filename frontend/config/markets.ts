...
// Tickers with 1-minute data available (verified from DB, earliest: 2026-01-21)
// Group B (hourly-only) tickers are intentionally excluded from the frontend
...
// Earliest date for 1-minute BIST data (all BIST_AVAILABLE tickers start from this date)
export const BIST_1MIN_EARLIEST = '2026-01-21';
...
// XU100 (BIST 100) constituents — filtered to tickers with 1-min data available
// Source: Borsa Istanbul XU100 index, verified April 2026
export const BIST_100 = [
    'AEFES', 'AGHOL', 'AKBNK', 'AKCNS', 'AKENR', 'AKSA',  'AKSEN',
    'ALARK', 'ARCLK', 'ARDYZ', 'ASELS', 'ASTOR', 'BAGFS', 'BIMAS', 'BRSAN', 'BTCIM',
    'CCOLA', 'CIMSA', 'CLEBI', 'DEVA',  'DOAS',  'DOHOL', 'ECILC', 'EKGYO',
    'ENJSA', 'ENKAI', 'EREGL', 'FROTO', 'GARAN', 'GUBRF', 'GWIND',
    'HALKB', 'HEKTS', 'ISCTR', 'ISGYO', 'KAREL', 'KCHOL', 'KLRHO', 'KONTR', 'KRDMD',
    'KTLEV', 'LOGO',  'MAVI',  'MGROS', 'MPARK', 'NETAS', 'ODAS',
    'OTKAR', 'OYAKC', 'PETKM', 'PETUN', 'PGSUS', 'PRKME', 'SAHOL',
    'SASA',  'SELEC', 'SISE',  'SKBNK', 'SOKM',  'TAVHL', 'TCELL',
    'THYAO', 'TKFEN', 'TMSN',  'TOASO', 'TSKB',  'TTKOM', 'TTRAK', 'TUPRS',
    'TUREX', 'TURSG', 'ULKER', 'VAKBN', 'VESBE', 'VESTL', 'YEOTK', 'YKBNK', 'ZOREN',
] as const;
...
export const TICKER_NAMES: Record<string, string> = {
    ...
    ZEDUR: 'Zedur Enerji',
    ZOREN: 'Zorlu Enerji',
    // Previously listed as unavailable, now confirmed with 1-min data
